...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 02 2026 г., 19:50
...
(13, 7, 4, 'Stay', '25.99', 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80', 1, '2026-02-01 15:36:35'),
...
(1, 'fill', 'fill@gmail.com', '$2y$10$I4T/Q4zku3JO/GAkSubcTeWjQRF230gbez61/JlrHaK6xPVDN6fkS', 'admin', 1, 'a5a2e01fa817d2c3771f5ccd29d206cc9855de29a6bf3e617aa2734d0026f72c', '2026-01-25 19:34:37', '2026-02-02 13:33:43'),
...
(3, 'www', 'www@w.ru', '$2y$10$vmRtlJXpV/GFo5X2H9sKsu1XYX1PAmHhl.BBlRzgFnHq8Adaa4jz.', 'user', 1, '9e524c4baf0c8ee22436b39f558313fe4320e15e637fd031b80d83d8eb12e8a4', '2026-01-25 19:46:07', '2026-02-02 13:35:30'),
...
(7, 'drg', 'drg@drg.ru', '$2y$10$mkWycRrQj7sed9UmBT6kduxhN7rfPy2AKDigS079ZoVZsrgN7V5iW', 'user', 1, '7dbeb369f7db974398a48aad8d695fba32e017978f92ae025d46fc57329ea14a', '2026-02-01 14:21:55', '2026-02-02 16:46:38'),
...
(1, 1, 'Дом', 'Филипп Иванов', '+7 (999) 123-45-67', 'Калининград', 'ул. Советская', '25', NULL, '2', '3', '17', 0, 1, 'Подъезд 2, этаж 3, кв. 17', '2026-02-01 15:24:23'),
...
(3, 1, 'Родители', 'Ивановы', '+7 (495) 123-45-67', 'Москва', 'ул. Лесная', '5', NULL, '42', NULL, '42', 0, 0, 'Домофон 42', '2026-02-01 15:24:23'),
...
(8, 7, '', NULL, NULL, '+79009001010', NULL, NULL, NULL, NULL, NULL, NULL, 1000, 5, 'active', '2026-02-01 16:34:41', '2026-02-01 16:34:41');
