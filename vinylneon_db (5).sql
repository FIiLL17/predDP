...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 01 2026 г., 17:33
...
(1, 'fill', 'fill@gmail.com', '$2y$10$I4T/Q4zku3JO/GAkSubcTeWjQRF230gbez61/JlrHaK6xPVDN6fkS', 'admin', 1, NULL, '2026-01-25 19:34:37', '2026-01-29 18:54:59'),
...
(3, 'www', 'www@w.ru', '$2y$10$vmRtlJXpV/GFo5X2H9sKsu1XYX1PAmHhl.BBlRzgFnHq8Adaa4jz.', 'user', 1, '272c1ff3a121fd1eb2b6113705455e6eb55747dd5ef2f57c52480f23d7111509', '2026-01-25 19:46:07', '2026-02-01 14:19:39'),
...
(7, 'drg', 'drg@drg.ru', '$2y$10$mkWycRrQj7sed9UmBT6kduxhN7rfPy2AKDigS079ZoVZsrgN7V5iW', 'user', 1, '4ebeb4da83c1d1f339ec5baaa6b80f80cc3efd9c2a273d150a6e5c9b3f7c554b', '2026-02-01 14:21:55', '2026-02-01 14:21:57');
...
CREATE TABLE `user_addresses` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `address_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'home',
...
INSERT INTO `user_addresses` (`id`, `user_id`, `address_type`, `full_name`, `address_line1`, `address_line2`, `city`, `postal_code`, `phone`, `is_default`, `created_at`) VALUES
(1, 1, 'home', 'Филипп Иванов', 'ул. Советская, д. 25, кв. 17', 'Подъезд 2, этаж 3', 'Калининград', '236000', '+7 (999) 123-45-67', 1, '2026-01-26 12:17:33'),
(2, 1, 'work', 'Филипп Иванов', 'ул. Горького, д. 10, офис 305', 'БЦ \"Неоновый\"', 'Калининград', '236001', '+7 (999) 987-65-43', 0, '2026-01-26 12:17:33'),
(3, 1, 'parents', 'Ивановы', 'ул. Лесная, д. 5, кв. 42', 'Домофон 42', 'Москва', '123456', '+7 (495) 123-45-67', 0, '2026-01-26 12:17:33'),
(4, 1, 'home', 'Филипп Иванов', 'ул. Советская, д. 25, кв. 17', NULL, 'Калининград', NULL, '+7 (999) 123-45-67', 1, '2026-01-26 12:21:45');
...
INSERT INTO `user_profiles` (`id`, `user_id`, `first_name`, `last_name`, `phone`, `birth_date`, `avatar_url`, `city`, `address`, `bonus_points`, `discount_percent`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 'Филипп', 'Иванов', '+7 (999) 123-45-67', '1990-05-15', NULL, 'Калининград', 'ул. Советская, д. 25, кв. 17', 1540, 5, 'active', '2026-01-26 12:07:42', '2026-01-29 17:40:09'),
(2, 2, 'ggg', '', '+7 (999) 123-45-67', NULL, NULL, 'Москва', NULL, 1000, 5, 'active', '2026-01-26 12:07:42', '2026-01-26 12:07:42'),
(3, 5, 'sws', '', '+7 (999) 123-45-67', NULL, NULL, 'Москва', NULL, 1000, 5, 'active', '2026-01-26 12:07:42', '2026-01-26 12:07:42'),
(4, 4, 'ttt', '', '+7 (999) 123-45-67', NULL, NULL, 'Москва', NULL, 1000, 5, 'active', '2026-01-26 12:07:42', '2026-01-26 12:07:42'),
(5, 3, 'www', '', '+7 (999) 123-45-67', NULL, NULL, 'Москва', NULL, 1000, 5, 'active', '2026-01-26 12:07:42', '2026-01-26 12:07:42');
